...
export default defineDashboardExtension({
    ...
    routes: [
        ...
        },
        {
            path: '/bbb/plans',
            component: () => <PlansList />,
            navMenuItem: { sectionId: 'bbb', title: 'Capacity Grants', icon: CreditCardIcon, id: 'bbb-plans', url: '/bbb/plans', requiresPermission: ['BBBAdmin', 'BBBManageOrganizations'] },
        },
        {
            path: '/bbb/trials',
            component: () => <TrialRegistrationsList />,
            navMenuItem: { sectionId: 'bbb', title: 'Trial Registrations', icon: ClipboardCheckIcon, id: 'bbb-trials', url: '/bbb/trials', requiresPermission: ['BBBAdmin', 'BBBManageSessions'] },
        },
        {
