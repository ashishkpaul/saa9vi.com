// src/plugins/reviews/ui/components/product-review-detail/product-review-detail.component.ts
...
{
    // Initialize detailForm in the constructor after formBuilder is available
    ...
    constructor(
        ...
        super();
        // Initialize detailForm here, after formBuilder is injected
