...
## Free Basic plan + storefront commercial integration (programme) — ⏳ IN PROGRESS (plan §4 slices 1–5, 7–9 done; **next: slice 10 (R4 runtime evidence)**; slice 6 still open, now unblocked)
